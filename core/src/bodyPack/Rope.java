...
public class Rope {
    ...
    public void render(SpriteBatch sb){
        sb.begin();
        for (Body body : rope)
            sb.draw(tex, body.getPosition().x *PPM, body.getPosition().y *PPM, width/2, height/2, width, height, /*scaleX*/1, /*scaleY*/1, /*rotation*/ body.getAngle() * MathUtils.radDeg, 0, 0, 10, 2, /*flipX*/false, /*flipY*/false);
        sb.end();
    }
